...
<body>
	...
	<div class="container">
		...
		<form:form method="${_method}" modelAttribute="priceChange" action="${_action}">
			<table>
				<caption>${pageTitle}</caption>
				<tbody>
					<tr>
						<td><spring:message code="priceChange.label.name" /></td>
						<td><form:input path="name"/></td>
						<form:errors path="name" element="td" cssClass="errorMessage"/>
					</tr>
					<tr>
						<td><spring:message code="priceChange.label.value" /></td>
						<td><form:input path="value"/></td>
						<form:errors path="value" element="td" cssClass="errorMessage"/>
					</tr>
					<tr>
						<td><spring:message code="priceChange.label.type" /></td>
